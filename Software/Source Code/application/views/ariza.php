					...
					<div class="body">
						<div class="row">
							<table class="pull-left col-md-6 col-xs-12 col-sm-12 m-l-15">
								<tbody>
									<tr>
										<td><strong>Asansör Adı</strong></td>
							...
							<div class="col-md-12">
								<a target="_blank" href="https://www.google.com/maps/search/?api=1&query=<?=$ariza->asansor_latitude?>,<?=$ariza->asansor_longitude?>" class="btn bg-blue waves-effect"><i class="material-icons">directions</i>
									<span>Yol Tarifi Al</span></a>
									<?php if($ariza->ariza_durum != "Onarıldı" && $ariza->ariza_onaran == $this->session->userdata("id")){ ?>
										<button type="button" class="btn bg-amber waves-effect" data-toggle="modal" data-target="#degisim">
