...
class Rapor extends CI_Controller {
	...
	public function index($report = false)
	{
		...
		if($report == "asansor"){
			...
			$reportTableData = ["ariza_id" => "#", "ariza_kodu" => "Arıza Kod", "ariza_timestamp" => "Arıza Tarihi", "asansor_kodu" => "Asansör Kodu", "musteri_adSoyad" => "Asansör Yetkili", "ariza_durum" => "Arıza Durumu"];
		}else if($report == "bakim"){
			$reportTableData = ["bakim_id" => "#", "bakim_icerik" => "Bakım İçeriği", "bakim_durum" => "Bakım Durumu", "asansor_kodu" => "Asansör Kodu", "kullanici_adSoyad" => "Bakım Yapan Yetkili"];
		}
