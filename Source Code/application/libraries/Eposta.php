 ...
 * @Last Modified time: 2018-07-16 23:48:27
 */
class Eposta
{
	protected $ci;
	...
	public function passwordReset($name, $hash, $email)
	{
		...
		$config['smtp_user'] = 'resetpassword@webcrea.pw';
		$config['smtp_pass'] = 'resetpassword12345';
		$config['smtp_port'] = 	587;
		$config['mailtype']  = 'html';
		$this->ci->email->initialize($config);
		$this->ci->email->from('resetpassword@webcrea.pw');
